...
public class SetPartService extends BaseLogicService {
    ...
    public BaseResponse getListBySetId(Long setId, PageRequest request) {
        BaseResponse response;
        try {
            response = new BaseResponse();
            response.setBody(setPartDataManager.getPartsBySetId(setId, getCriteria(request, SetPartFullDto.class)));
