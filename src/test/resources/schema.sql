...
(
    LEGO_ID               BIGINT                 NOT NULL,
    LEGO_NAME             CHARACTER VARYING(255) NOT NULL,
    LEGO_NUMBER           CHARACTER VARYING(20)  NOT NULL,
    LEGO_ALTERNATE_NUMBER CHARACTER VARYING(255),
...
CREATE ALIAS STRING_TO_ARRAY FOR "ru.shark.home.legomanager.util.H2Functions.stringToArray";
CREATE ALIAS ARRAY_POSITION FOR "ru.shark.home.legomanager.util.H2Functions.arrayPosition";